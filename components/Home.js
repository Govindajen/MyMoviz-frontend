...
function Home() {
  ...
  useEffect(() => {
    fetch('https://my-moviz-backend-mocha.vercel.app/movies').then(response => response.json())
    .then(data => {

      //console.log('TheApi data -->',data)
      setMovies(data.movies);

      //console.log('fetch data useState', moviesData)
    })
  }, [])


  //console.log('MyMovie data var', moviesData.apiData.results)
...
/*   const moviesData = [
    ...
    { title: 'Your name', poster: 'https://image.tmdb.org/t/p/original/wkfG7DaExmcVsGLR4kLouMwxeT5.jpg', voteAverage: 8.5, voteCount: 8_691, overview: 'High schoolers Mitsuha and Taki are complete strangers living separate lives. But one night, they suddenly switch places.' },
